...
const STUDENTS_DATA = [
    { id: "ARB-001", name: "أحمد محمود", age: 10, joinDate: "15 يناير 2026", level: "المستوى الأول - مبتدئ" },
    { id: "ARB-002", name: "عمر عبد الله", age: 12, joinDate: "20 يناير 2026", level: "المستوى الثاني - متوسط" },
    { id: "ARB-003", name: "فاطمة علي", age: 9, joinDate: "01 فبراير 2026", level: "المستوى الأول - مبتدئ" },
    { id: "ARB-004", name: "زينب حسن", age: 11, joinDate: "15 فبراير 2026", level: "المستوى الثالث - متقدم" },
    { id: "ARB-005", name: "يوسف طارق", age: 8, joinDate: "05 مارس 2026", level: "المستوى التمهيدي" },
];
                ...
                <div className="mx-auto w-full max-w-5xl">
                    <header className="mb-10 text-center">
                        <span className="mb-4 inline-block rounded-full bg-emerald-100 px-5 py-2 text-sm font-bold text-emerald-700 shadow-sm border border-emerald-200/50">
                            بوابة المعلمين - العربية لغير الناطقين
                        </span>
                        ...
                        <p className="mx-auto max-w-xl text-base text-slate-600 sm:text-lg text-balance">
                            قائمة بجميع الطلبة المسجلين لديك في قسم العربية لغير الناطقين.
                        </p>
                    </header>
                            ...
                            <table className="w-full text-right text-sm text-slate-600">
                                <thead className="bg-emerald-50/80 text-emerald-900 border-b border-emerald-200/60">
                                    <tr>
                                        ...
                                        <th scope="col" className="px-6 py-4 font-bold">المستوى الدراسي</th>
