...
const STUDENTS_DATA = [
    { id: "QUR-001", name: "طالب ركن القرآن", email: "student1@gmail.com", age: 10, joinDate: "15 يناير 2026", level: "الجزء الأول" },
    { id: "QUR-002", name: "عمر عبد الله", email: "omar@example.com", age: 12, joinDate: "20 يناير 2026", level: "الجزء الثاني" },
    { id: "QUR-003", name: "فاطمة علي", email: "fatma@example.com", age: 9, joinDate: "01 فبراير 2026", level: "التحفة السنية" },
];
                ...
                <div className="mx-auto w-full max-w-5xl">
                    <header className="mb-10 text-center">
                        ...
                        <p className="mx-auto max-w-xl text-base text-slate-600 sm:text-lg text-balance">
                            إدارة وتحديث تقدم الطلاب المسجلين لديك في قسم ركن القرآن.
                        </p>
                    </header>
                            ...
                            <table className="w-full text-right text-sm text-slate-600">
                                <thead className="bg-emerald-50/80 text-emerald-900 border-b border-emerald-200/60">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4 font-bold">المستوى / المحفوظ</th>
